...
export class GraphOptionsComponent implements OnInit {
  ...
  public createGraph(newPlot: Boolean) {
    ...
    // adjust plotly button font-size
    if (document.getElementsByClassName('modebar-btn') !== undefined) {
      for (let el in document.getElementsByClassName('modebar-btn')) {
        if (document.getElementsByClassName('modebar-btn')[el]['style'] !== undefined) {
          document.getElementsByClassName('modebar-btn')[el]["style"].fontSize = "25px";
        }
      }
    }
  }
